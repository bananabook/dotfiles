...
#pipes()
#{
#	command /home/david/git/pipes.sh/pipes.sh -t1 -p4 -r50000 -R
#}
#pipesd()
#{
#	command /home/david/git/pipes.sh/pipes.sh 
#}

bonsai()
{
	command /home/david/git/bonsai.sh/bonsai.sh -g 45,60 $*
}
...
export EDITOR=vim
export PS1="\e[40;0;32m$ \e[40;0;37m"
export PATH="~/git:$PATH"
# \a make sound
# export PS1="\e[40;0;32mΔ \e[40;0;37m"
...
umatdefault(){
	python3 ~/git/unimatrix/unimatrix.py -a -s 95 -f $*
}
...
alias cac='/opt/cisco/anyconnect/bin/vpn connect $IRT_VPN'
